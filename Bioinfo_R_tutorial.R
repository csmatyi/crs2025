# Find more files in D:\Concordia_250521\Courses\Courses\2_2024Spring\Bioinfo_CSC491\exercises
...
sqrt(9)
sqrt(25)
sin(pi/4) # here pi = 3.14159
log10(100) # log2(16), log(121,base=11)
abs(-4)
factorial(5)
# n!/(k! x (n-k)!)
choose(5,3)
...
# using SIMPLFY in mapply to write out results on one line
